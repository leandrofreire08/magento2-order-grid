...
/**
 * Class AddCouponCodeDiscountAmountToSalesOrderGrid
 */
class AddCouponCodeDiscountAmountToSalesOrderGrid implements DataPatchInterface, PatchVersionInterface
{
    /**
    ...
    public function apply()
    {
        $this->state->emulateAreaCode(
            ...
            [$this, 'addCouponCodeDiscountAmountToSalesOrderGrid'],
            [$this->moduleDataSetup]
        );
    }

    /**
     * Add CouponCode DiscountAmount To Sales Order Grid
     *
     * @param ModuleDataSetupInterface $setup
     */
    public function addCouponCodeDiscountAmountToSalesOrderGrid(ModuleDataSetupInterface $setup)
    {
